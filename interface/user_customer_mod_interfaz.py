...
class AppUserCustomerMod(BaseWindow):
    ...
    def __init__(self, select_data):
        ...
        id_customer= select_data[2]
        id_user_customer = select_data[3]

        user_customer_data=get_user_customer_data(user, password, id_customer,id_user_customer)
        ...
        self.name_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[2],
        ...
        self.surname_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[3],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
        ...
        self.email_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[4],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
        ...
        self.phone_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[5],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
    ...
    def save(self, select_data):
        ...
        mod_user_customer_item(user, password, data,id_customer, id_user_customer)
