...
class AppManagerProject(customtkinter.CTkToplevel):
    width = 1500
    height = 800
    ...
    def __init__(self,main_view, select_data):
        ...
        self.view_manager_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=5, height=40,
                                                           border_spacing=10, text="Acceder a GESTIÓN DE PROYECTOS",
                                                           text_color=("gray10", "gray90"),
                                                           hover_color=("gray70", "gray30"),
                                                           font=("default", 14, "bold"),
                                                           anchor="center",
                                                           command=lambda: self.view_manager_button_event(select_data))
        self.view_manager_button.grid(row=9, padx=30, pady=(15, 15), sticky="nsew")
        ...
        self.tree_data_hidro.column("Descripción", anchor=customtkinter.CENTER, width=100)
        self.tree_data_hidro.column("Partida", anchor=customtkinter.CENTER, width=40)
        # Definir encabezados
        ...
        self.tree_data_regis.column("Partida", anchor=customtkinter.CENTER, width=40)
        # Definir encabezados
    ...
    def view_manager_button_event(self, access):
        self.destroy()
        self.ventana_principal.on_closing()
    ...
    def update_data_frame_resume(self,select_data):
        # actaulizamos resumen de los resgistros del proyecto
    ...
    def register_filter_event(self,select_data):
        ...
        code_register_select = self.select_register.split(" - ")[0]
        id_register_select = get_id_item_bd(select_data[0], select_data[1], "tbl_inventario", select_data[2],  "codigo",
                                            str(code_register_select))
