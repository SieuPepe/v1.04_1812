...
from script.modulo_db  import add_user_customer_item
import os
...
class AppUserCustomerAddNew(customtkinter.CTkToplevel):
    width = 600
    height = 300
    ...
    def save(self, access):
        ...
        add_user_customer_item(user, password, data,id_customer)
