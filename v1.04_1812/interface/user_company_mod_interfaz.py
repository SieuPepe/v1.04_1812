...
from script.modulo_db  import get_user_company_data, mod_user_company_item
import os
...
class AppUserCompanyMod(customtkinter.CTkToplevel):
    width = 600
    height = 300
    ...
    def __init__(self, select_data):
        ...
        id_user_customer = select_data[2]

        user_customer_data=get_user_company_data(user, password, id_user_customer)
        self.select_user_customer = [tk.StringVar(value=data) for data in user_customer_data[0]]
        ...
        self.name_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[1],
        ...
        self.surname_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[2],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
        ...
        self.email_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[3],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
        ...
        self.phone_customer_entry = customtkinter.CTkEntry(self, textvariable= self.select_user_customer[4],
                                                         fg_color=common_fg_color,text_color="#FFFFFF")
    ...
    def save(self, select_data):
        ...
        mod_user_company_item(user, password, data, id_user_customer)
        #mostramos mensage de confirmacion y cerramos ventana
        mssg=f'Se ha modificado los datos del responsable: {data["name"]} {data["surname"]}'
        self.destroy()
