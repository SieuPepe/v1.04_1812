...
class AppElementAdd(customtkinter.CTkToplevel):  # Toplevel
    ...
    def __init__(self, select_data):
        ...
        self.type_register_option = customtkinter.CTkOptionMenu(self.filter_register_frame,
                                                       ...
                                                       command= lambda event:self.update_register_model_options(select_data))
        ...
        id_type_register = get_id_item_bd(user, password, 'tbl_cata_regis_tipo', schema, 'tipo', self.type_register_option.get())
        register_model_value = get_option_item_sub_bd(user, password, 'tbl_catalogo_registros', schema, 'modelo',id_type_register,'id_tipo_registro')
        ...
        self.n_item_register_label = customtkinter.CTkLabel(self.filter_register_frame, text="Cantidad",
                                                         anchor="center", font=customtkinter.CTkFont(size=13, weight="bold"),
                                                         width= 50)
        ...
        self.n_item_register_entry = customtkinter.CTkEntry(self.filter_register_frame, textvariable=n_item_register_value,
        ...
        self.add_button_register = customtkinter.CTkButton(self.filter_register_frame, text="Añadir", command=lambda: self.add_item_register(select_data), fg_color="green")
        ...
        self.remove_button_register = customtkinter.CTkButton(self, text="Eliminar", command=self.remove_item_register, fg_color="red")
        self.remove_button_register.grid(row=1, column=1, pady=15)
        # Flecha hacia arriba
        self.up_button_register = customtkinter.CTkButton(self, text="↑", command=self.move_up_register, font=("default", 14, "bold"), )
        self.up_button_register.grid(row=2, column=1, pady=15)
        # Flecha hacia abajo
        self.down_button_register = customtkinter.CTkButton(self, text="↓", command=self.move_down_register, font=("default", 14, "bold"))
        ...
        self.n_lines_hidro_label = customtkinter.CTkLabel(self.filter_hidro_frame, text="Es necesario definir el número de lineas para añadir elementos",
                                                       anchor="center",
                                                       font=customtkinter.CTkFont(size=13))
        ...
        # Botón para eliminar elementos seleccionados
        self.remove_button_hidro = customtkinter.CTkButton(self, text="Eliminar", command=self.remove_item_hidro,fg_color="red")
        self.remove_button_hidro .grid(row=5, column=1, pady=15)
        # Flecha hacia arriba
        self.up_button_hidro  = customtkinter.CTkButton(self, text="↑", command=self.move_up_hidro, font=("default", 14, "bold"),)
        self.up_button_hidro .grid(row=6, column=1, pady=15)
        # Flecha hacia abajo
        self.down_button_hidro  = customtkinter.CTkButton(self, text="↓", command=self.move_down_hidro, font=("default", 14, "bold"))
    ...
    def update_register_model_options(self,select_data):
        ...
        register_model_value = get_option_item_sub_bd(select_data[0], select_data[1], 'tbl_catalogo_registros', select_data[2], 'modelo',
    ...
    def add_item_hidro(self, select_data):
        ...
        id_type_hidro = get_id_item_bd(select_data[0], select_data[1], 'tbl_cata_hidra_tipo', select_data[2], 'tipo_elemento',
                                          self.type_hidro_option.get())
        hidro_model_value = get_option_item_sub_bd(select_data[0], select_data[1], 'tbl_catalogo_hidraulica', select_data[2], 'modelo',
