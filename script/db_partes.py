...
def add_parte_mejorado(user: str, password: str, schema: str,
    ...
    with get_project_connection(user, password, schema) as cn:
        ...
        # Generar código único por prefijo (formato: PREFIX/NNNN)
        # Cada tipo de trabajo (GF, OT, TP) tiene su propia secuencia independiente
        ...
        query_next = (
            ...
            "WHERE codigo IS NOT NULL AND codigo LIKE %s"
        )
        pattern = f"{prefix}/%"
