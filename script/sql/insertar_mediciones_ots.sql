...
SELECT * FROM (
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40587') AS precio_id,
        1.5 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40587') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0453') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20003') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0425') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40590') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40590') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20002') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41195') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41195') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0407') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40644') AS precio_id,
        2.0 AS cantidad,
        '2025-10-17' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40644') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30001') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30001') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0109') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30010') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30010') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41046') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41046') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
        8.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30011') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
        6.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40798') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40691') AS precio_id,
        1.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40691') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40717') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0309') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20004') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40893') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40893') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '10003') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '10003') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40565') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40565') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41048') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41048') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0241') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20005') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20005') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40751') AS precio_id,
        1.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40751') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0103') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40646') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40646') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40561') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40561') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40344') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40344') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'GF/0004') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20001') AS precio_id,
        176.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20001') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40831') AS precio_id,
        8.0 AS cantidad,
        '2025-10-09' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40831') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30008') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30008') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40754') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40754') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40350') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40350') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40752') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40752') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40755') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40755') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30009') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30009') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0150') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40105') AS precio_id,
        4.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40105') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41063') AS precio_id,
        12.0 AS cantidad,
        '2025-10-29' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41063') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40028') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40028') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40839') AS precio_id,
        1.0 AS cantidad,
        '2025-10-16' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40839') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40629') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40629') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40643') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40643') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0102') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30003') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30003') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41187') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41187') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40941') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40941') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0203') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40027') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40027') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41114') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41114') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40204') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40204') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0458') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41181') AS precio_id,
        1.0 AS cantidad,
        '2025-10-31' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41181') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0244') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40831') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40556') AS precio_id,
        1.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40556') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0427') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40099') AS precio_id,
        0.5 AS cantidad,
        '2025-09-22' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40099') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40334') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40334') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40107') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40107') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41064') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41064') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40764') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40764') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0174') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41175') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41175') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0489') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40614') AS precio_id,
        1.0 AS cantidad,
        '2025-10-31' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40614') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40012') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40012') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0207') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40026') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40026') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0269') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41194') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41194') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40601') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40601') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40718') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40718') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40552') AS precio_id,
        1.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40552') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40059') AS precio_id,
        1.0 AS cantidad,
        '2025-10-08' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40059') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0515') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40590') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0152') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41045') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41045') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41016') AS precio_id,
        8.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41016') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40483') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40483') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40020') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40020') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0244') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40131') AS precio_id,
        0.5 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40131') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40829') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40829') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40553') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40553') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0215') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40847') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40847') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0398') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41064') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41025') AS precio_id,
        5.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41025') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0129') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30012') AS precio_id,
        10.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30012') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0223') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40048') AS precio_id,
        1.0 AS cantidad,
        '2025-09-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40048') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0257') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40014') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40014') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0494') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40018') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40018') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41182') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41182') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30008') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41042') AS precio_id,
        1.5 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41042') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0500') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40882') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40882') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40820') AS precio_id,
        4.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40820') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0166') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40133') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40133') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40602') AS precio_id,
        10.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40602') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40999') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40999') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40830') AS precio_id,
        1.0 AS cantidad,
        '2025-10-17' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40830') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0451') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41047') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41047') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30002') AS precio_id,
        1.0 AS cantidad,
        '2025-09-24' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30002') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40341') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40341') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0118') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40243') AS precio_id,
        4.0 AS cantidad,
        '2025-10-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40243') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40843') AS precio_id,
        1.0 AS cantidad,
        '2025-10-09' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40843') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41076') AS precio_id,
        8.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41076') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0398') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40736') AS precio_id,
        1.0 AS cantidad,
        '2025-10-08' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40736') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0061') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30012') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0377') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40759') AS precio_id,
        2.0 AS cantidad,
        '2025-10-29' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40759') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0475') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40655') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40655') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0224') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40612') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40612') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40589') AS precio_id,
        1.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40589') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0515') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40831') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0303') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40608') AS precio_id,
        1.0 AS cantidad,
        '2025-10-16' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40608') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0176') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40407') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40407') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40560') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40560') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0397') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41065') AS precio_id,
        5.0 AS cantidad,
        '2025-10-08' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41065') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40634') AS precio_id,
        2.0 AS cantidad,
        '2025-10-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40634') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30001') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20007') AS precio_id,
        8.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20007') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0269') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40815') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40815') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0441') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40646') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0180') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40137') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40137') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40470') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40470') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0471') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41132') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41132') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40838') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40838') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0201') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40325') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40325') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0214') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0180') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40878') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40878') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0220') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40024') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40024') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0494') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40025') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40025') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0136') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '50004') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '50004') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0155') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '50006') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '50006') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0346') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40562') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40562') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0507') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'GF/0003') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '10002') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '10002') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0398') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40840') AS precio_id,
        1.0 AS cantidad,
        '2025-10-09' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40840') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'GF/0001') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '10004') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '10004') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40369') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40369') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40588') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40588') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0098') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41032') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41032') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40625') AS precio_id,
        2.0 AS cantidad,
        '2025-10-29' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40625') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41131') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41131') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0269') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40357') AS precio_id,
        4.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40357') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0154') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40551') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40551') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0156') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41149') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41149') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0310') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40366') AS precio_id,
        4.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40366') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41184') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41184') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30002') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0133') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30004') AS precio_id,
        5.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30004') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0496') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40845') AS precio_id,
        4.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40845') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0476') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41185') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41185') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0265') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40475') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40475') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0268') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41174') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41174') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40588') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0304') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40615') AS precio_id,
        1.0 AS cantidad,
        '2025-09-29' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40615') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0174') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41039') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41039') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0108') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40136') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40136') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0269') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41007') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41007') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0178') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0484') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40823') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40823') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0367') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41177') AS precio_id,
        1.0 AS cantidad,
        '2025-09-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41177') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0476') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40614') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0500') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40664') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40664') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0203') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41138') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41138') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0026') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40802') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40802') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30002') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0235') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40057') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40057') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40644') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0203') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40645') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40645') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0161') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0474') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40871') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40871') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0389') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0470') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40563') AS precio_id,
        1.0 AS cantidad,
        '2025-10-27' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40563') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40761') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40761') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0053') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40849') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40849') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0377') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0471') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40692') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40692') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0176') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41140') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41140') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0469') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40001') AS precio_id,
        1.0 AS cantidad,
        '2025-10-26' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40001') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0278') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40026') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41037') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41037') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0463') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0175') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40009') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40009') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0432') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40764') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0309') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40611') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40611') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0258') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0449') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40598') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40598') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0432') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40611') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0468') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40363') AS precio_id,
        1.0 AS cantidad,
        '2025-10-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40363') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0470') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41043') AS precio_id,
        1.0 AS cantidad,
        '2025-10-27' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41043') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0345') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40593') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40593') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0156') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40348') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40348') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0469') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40108') AS precio_id,
        1.0 AS cantidad,
        '2025-10-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40108') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41133') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41133') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41057') AS precio_id,
        4.0 AS cantidad,
        '2025-10-02' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41057') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0432') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0449') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41155') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41155') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0395') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40846') AS precio_id,
        1.0 AS cantidad,
        '2025-10-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40846') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0025') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41039') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40931') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40931') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0149') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '50016') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '50016') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0199') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41033') AS precio_id,
        3.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41033') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0367') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41195') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0470') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40479') AS precio_id,
        1.0 AS cantidad,
        '2025-10-27' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40479') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0255') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0320') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41004') AS precio_id,
        1.0 AS cantidad,
        '2025-09-19' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41004') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40659') AS precio_id,
        2.0 AS cantidad,
        '2025-10-02' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40659') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0048') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0350') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40011') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40011') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40930') AS precio_id,
        1.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40930') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0494') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40108') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0248') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40873') AS precio_id,
        2.0 AS cantidad,
        '2025-09-02' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40873') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0316') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0112') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40709') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40709') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0225') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41133') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41084') AS precio_id,
        14.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41084') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30001') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40140') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40140') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0153') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0492') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41061') AS precio_id,
        3.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41061') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41014') AS precio_id,
        12.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41014') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30002') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0290') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41066') AS precio_id,
        2.5 AS cantidad,
        '2025-09-17' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41066') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0490') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0379') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40006') AS precio_id,
        1.0 AS cantidad,
        '2025-10-04' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40006') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40586') AS precio_id,
        6.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40586') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0240') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0287') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41096') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41096') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0181') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0014') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40757') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40757') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0491') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0410') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40657') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40657') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0485') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40615') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0316') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40841') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40841') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'GF/0005') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '10003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0250') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40016') AS precio_id,
        1.0 AS cantidad,
        '2025-09-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40016') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40360') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40360') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0328') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40656') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40656') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0249') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0269') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40640') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40640') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40351') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40351') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0345') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40480') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40480') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0471') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41188') AS precio_id,
        3.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41188') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41020') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41020') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0075') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30012') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40650') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40650') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0305') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40712') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40712') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40184') AS precio_id,
        1.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40184') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0238') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0181') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41116') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41116') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0331') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40754') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0215') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40603') AS precio_id,
        10.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40603') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41194') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0136') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40753') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40753') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0388') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40760') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40760') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40693') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40693') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0238') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40590') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40810') AS precio_id,
        1.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40810') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0173') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0490') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40019') AS precio_id,
        1.0 AS cantidad,
        '2025-10-31' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40019') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40178') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40178') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0204') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41187') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0345') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41062') AS precio_id,
        6.0 AS cantidad,
        '2025-09-25' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41062') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0225') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0320') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40708') AS precio_id,
        1.0 AS cantidad,
        '2025-09-19' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40708') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0357') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40624') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40624') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0346') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40832') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40832') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0432') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0320') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40165') AS precio_id,
        1.0 AS cantidad,
        '2025-09-19' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40165') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0397') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0320') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40362') AS precio_id,
        2.0 AS cantidad,
        '2025-09-19' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40362') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40706') AS precio_id,
        2.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40706') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0115') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '50018') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '50018') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0152') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40609') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40609') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0267') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41046') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0180') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40371') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40371') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0320') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41015') AS precio_id,
        8.0 AS cantidad,
        '2025-09-19' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41015') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0383') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40645') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0026') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40610') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40610') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0476') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41152') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41152') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0425') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40827') AS precio_id,
        2.0 AS cantidad,
        '2025-10-01' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40827') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0494') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0295') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41125') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41125') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40595') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40595') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0431') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40611') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0419') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40473') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40473') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0153') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40605') AS precio_id,
        40.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40605') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0264') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0336') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40031') AS precio_id,
        1.0 AS cantidad,
        '2025-09-23' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40031') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0156') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40855') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40855') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0319') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0256') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40008') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40008') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0157') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0470') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40469') AS precio_id,
        1.0 AS cantidad,
        '2025-10-27' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40469') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0368') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40773') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40773') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0398') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40829') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0174') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40781') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40781') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0062') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30012') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0168') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40023') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40023') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0245') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40875') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40875') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0497') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41181') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0306') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40324') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40324') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0233') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40646') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0161') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40694') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40694') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0062') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0225') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41024') AS precio_id,
        16.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41024') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0270') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40551') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0390') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40592') AS precio_id,
        1.0 AS cantidad,
        '2025-10-07' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40592') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0172') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41046') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0201') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40492') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40492') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40774') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40774') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0311') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40014') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0410') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40641') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40641') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0337') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0176') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40253') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40253') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'GF/0001') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '10001') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '10001') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40191') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40191') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0163') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0026') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40750') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40750') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0244') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41026') AS precio_id,
        6.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41026') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0075') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0500') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40986') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40986') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0119') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41077') AS precio_id,
        12.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41077') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0328') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40613') AS precio_id,
        2.0 AS cantidad,
        '2025-09-21' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40613') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0083') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30011') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        ...
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20006') AS precio_id,
        48.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '20006') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0238') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40059') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0176') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40177') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40177') AS precio_unit
) AS temp
WHERE temp.parte_id IS NOT NULL AND temp.precio_unit IS NOT NULL;
COMMIT;
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0420') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40013') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40013') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0127') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '30006') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '30006') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0379') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40899') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40899') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0438') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40754') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0174') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40485') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40485') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0338') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20004') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0387') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40874') AS precio_id,
        1.0 AS cantidad,
        '2025-10-06' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40874') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0412') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20003') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0296') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40010') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40010') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0382') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40798') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0446') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40745') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40745') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0195') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20002') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0225') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40189') AS precio_id,
        3.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40189') AS precio_unit
    UNION ALL
    SELECT
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0367') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40617') AS precio_id,
        1.0 AS cantidad,
        '2025-09-30' AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40617') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0200') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40717') AS precio_id,
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0024') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '50008') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '50008') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0175') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '20005') AS precio_id,
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'TP/0152') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40743') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40743') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0265') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '41172') AS precio_id,
        1.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '41172') AS precio_unit
    UNION ALL
    SELECT
...
SELECT * FROM (
    ...
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0124') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40180') AS precio_id,
        2.0 AS cantidad,
        NULL AS fecha,
        (SELECT coste FROM tbl_pres_precios WHERE codigo = '40180') AS precio_unit
    UNION ALL
    SELECT
        (SELECT id FROM tbl_partes WHERE codigo = 'OT/0236') AS parte_id,
        (SELECT id FROM tbl_pres_precios WHERE codigo = '40829') AS precio_id,
